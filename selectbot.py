...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    context.user_data["video_files"] = [f for f in os.listdir(VIDEO_FOLDER) if f.endswith(('.xml', '.txt'))]
...
async def search_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    all_files = [f for f in os.listdir(VIDEO_FOLDER) if f.endswith(('.xml', '.txt'))]
